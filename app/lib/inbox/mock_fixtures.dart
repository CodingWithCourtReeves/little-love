...
/// by `--dart-define=LLOVE_FIXTURES=demo` (see main.dart). Each room has a
/// `members` list with the local user + their partner.
...
void seedDemoFixtures(ProviderContainer container) {
  ...
  container.read(messageStoreProvider('demo-room-travel').notifier).setAll([
    Msg(
      id: 'demo-3',
      from: 'kaitlyn',
      to: 'court',
